 ...
 *
 * @return Returns an NSObject conforming to SDWebImageOperation. Should be an instance of SDWebImageDownloaderOperation. Returns nil if no operation created to download the image
 */
